...
<img src='https://i.imgur.com/pK6Nz8d.gif'/>
...
- tableView height automatically being set to a small value - had to change it to a fixed cell height

## License

    Copyright 2018 Omar Valenzuela
...
<img src='https://i.imgur.com/pK6Nz8d.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
# Lab 5 - Flix MVC Refactor

Flix MVC Refactor is a movies app displaying box office and top rental DVDs using [The Movie Database API](http://docs.themoviedb.apiary.io/#).
